...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `filedUnder` varchar(255) DEFAULT NULL");
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `herbarium` varchar(4) NOT NULL DEFAULT ''");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `accesNum` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `currName` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `idQualifier` varchar(16) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `detText` text DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `provenance` text DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `container` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `collTrip` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `highGeo` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `frequency` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `prepMethod` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `format` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `verbLat` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
SET @s := IF(@c>0,'DO 0',"ALTER TABLE `omoccurrences` ADD COLUMN `verbLong` varchar(255) DEFAULT NULL");
PREPARE stmt FROM @s; EXECUTE stmt; DEALLOCATE PREPARE stmt;
