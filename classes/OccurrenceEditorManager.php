...
class OccurrenceEditorManager {
	...
	public function __construct($conn = null) {
		...
		$this->fieldArr['omoccurrences'] = array('basisofrecord' => 's','catalognumber' => 's','othercatalognumbers' => 's','occurrenceid' => 's','ownerinstitutioncode' => 's',
			...
			'accesNum' => 'n', 'filedUnder' => 's', 'currName' => 's', 'idQualifier' => 's',
			'detText' => 's', 'provenance' => 's', 'container' => 's', 'collTrip' => 's',
			'geoWithin' => 's', 'highGeo' => 's', 'frequency' => 's', 'prepMethod' => 's',
			'format' => 's', 'verbLat' => 's', 'verbLong' => 's', 'method' => 's',
			'modified' => 's', 'dateLastModified' => 's');
	...
	public function saveOcrResult($imgId, $notes = null, $rawNotes = null, $rawSource = null) {
		...
		// PHP 8.2+: strip_tags + trim for OCR metadata (replaces removed FILTER_SANITIZE_STRING)
